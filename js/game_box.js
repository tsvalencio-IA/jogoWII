...
// STATUS: PLATINUM MASTER + INJEÇÃO 20/10 (SISTEMA ESQUIVA E PARTÍCULAS)
// =============================================================================
...
(function() {
    ...
    const Game = {
        ...
        update: function(ctx, w, h, inputPose) {
            try {
                ...
                if (this.state === 'FIGHT') {
                    ...
                    // --- INJEÇÃO 20/10: RENDERIZAR PARTÍCULAS SANGUE/SUOR ---
        ...
        processInput: function(input, w, h, dt) {
            ...
            if (this.state === 'FIGHT') {
                // --- INJEÇÃO 20/10: DODGE SYSTEM (ESQUIVA) ---
        ...
        checkHit: function(hand, attacker, defender) {
            ...
            if (hitHead || hitBody) {
                ...
                if (defender.guard) {
                    ...
                    // --- INJEÇÃO 20/10: SANGUE/SUOR IMPACTO ---
                    for(let i=0; i<8; i++) {
                        this.particles.push({
